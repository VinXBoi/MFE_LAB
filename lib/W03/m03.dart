...
import 'package:flutter_application_1/W06/m06.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(55, 20, 20, 20),
            child: Expanded(
                child: TextField(
                  ...
                  onPressed: () {
                    if (_judulController.text.isEmpty ||
                      ...
                      Provider.of<ItemProvider>(context, listen: false)
                          .addItem(_judulController.text, _descController.text);
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const W06Page()));
                    }
                  },
                  style: ElevatedButton.styleFrom(
                      minimumSize: const Size(200, 50),
